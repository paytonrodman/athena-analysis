...
# plt_B.py
#
# A program to plot the time-series of the average magnetic field strength in different
# regions of the disk, from data generated by calc_B.py
#
# Usage: python plt_B.py [options]
#
