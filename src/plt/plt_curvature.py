...
# plt_curvature.py
#
# A program to plot the time series of the curvature, kappa, within different regions of the disk,
# from data generated by calc_kappa.py
#
# Usage: python plt_curvature.py [options]
#
