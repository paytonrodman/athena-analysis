...
def main(**kwargs):
    ...
    if args.prob_id=='high_res':
        min_time = 2.5e4
    elif args.prob_id=='high_beta' or args.prob_id=='super_res' or args.prob_id=='b200_super_res':
        min_time = 1e4
    else:
        min_time = 0.
    ...
    if args.mag:
        ...
        savename = data_dir + 'plots/mag_flux_abs.png'
    elif args.ratio:
        data = np.asarray(mag_flux) / np.asarray(mag_flux_abs)
        ylab1 = r'$\frac{\oint B_r \cdot dS}{\oint |B_r| \cdot dS}$'
        savename = data_dir + 'plots/mag_flux_ratio.png'
    else:
        data = mag_flux
        ylab1 = r'$\sqrt{4\pi} \oint_{r_{\rm{hor}}} B_r \cdot dS$'
        savename = data_dir + 'plots/mag_flux.png'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inst_mass',
                        action='store_true',
                        help='use the instantaneous mass to scale the flux')
