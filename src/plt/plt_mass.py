...
# plt_mass.py
#
# A program to plot the time series of the mass flux through the ISCO of the disk, from data
# generated by calc_mass.py
#
# Usage: python plt_mass.py [options]
#
...
def main(**kwargs):
    ...
    plt.savefig(data_dir + 'plots/' + y_var_name + '.png', bbox_inches='tight')
    plt.close()
